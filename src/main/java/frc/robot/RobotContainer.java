...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        imSubsystem.setDefaultCommand(new IntakeMagazineDefaultCommand(imSubsystem, primaryJoystick));
    ...
    public void ConfigureControllers() {
        ...
        var gatherBalls = new JoystickButton(primaryJoystick, XboxController.Button.kB.value);
        gatherBalls.whileHeld(new GatherBallsCommandV2(imSubsystem, primaryJoystick));
    }
